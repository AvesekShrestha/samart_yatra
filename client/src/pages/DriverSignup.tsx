...
const DriverSignup = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const result = await signup({ ...signupData, role: 'driver' });
    setLoading(false);
      ...
      <div className="auth-container">
        ...
        >
          <div className="auth-header">
            ...
            <h2 className="auth-title">Driver Sign Up</h2>
          ...
          <form onSubmit={handleSubmit} className="auth-form">
            ...
            <button 
              ...
              disabled={loading}
            >
              {loading ? <LoadingSpinner size="small" /> : 'Sign Up as Driver'}
            </button>
          </form>
          ...
          <div className="auth-footer">
            ...
            <p>
              <Link to="/signup" className="auth-link">← Back to options</Link>
            </p>
          </div>
        </motion.div>
      </div>
